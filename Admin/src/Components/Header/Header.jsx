      ...
      <header>
        ...
        <div className={`rightNav ${sidetoggle ? "active" : ""} `}>
          <ul>
            ...
            <li className={isActive('/all-orders') || isActive("/edit-order") ? 'active' : ''} ><Link to="/all-orders" onClick={handletoggleBtn}> <i class="fa-solid fa-cart-shopping"></i> New Orders</Link></li>
            <li className={isActive('/get-all-orders') || isActive("/edit-order") ? 'active' : ''} ><Link to="/get-all-orders" onClick={handletoggleBtn}> <i class="fa-solid fa-upload"></i> All Orders</Link></li>
