...
const EditProduct = () => {
    ...
    useEffect(() => {
        ...
        const fetchProduct = async () => {
            try {
                const response = await axios.get(`https://api.goyattrading.shop/api/single-product/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.put(`https://api.goyattrading.shop/api/update-product/${id}`, formDataToSubmit, { headers: { 'Content-Type': 'multipart/form-data' } });
