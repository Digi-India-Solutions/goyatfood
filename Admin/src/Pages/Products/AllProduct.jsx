...
const AllProduct = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('http://localhost:12006/api/get-product');
    ...
    const handleDelete = async (productId) => {
        try {
            ...
            if (result.isConfirmed) {
                const response = await axios.delete(`http://localhost:12006/api/delete-product/${productId}`);
    ...
    const handleStatusChange = async (productId, field, currentValue) => {
        try {
            const response = await axios.put(`http://localhost:12006/api/update-product/${productId}`, {
