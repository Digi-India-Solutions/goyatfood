...
const AllContactInquery = () => {
    ...
    useEffect(() => {
        const fetchContacts = async () => {
            try {
                const response = await axios.get('https://api.goyattrading.shop/api/all-contacts');
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`https://api.goyattrading.shop/api/delete-contact/${id}`);
