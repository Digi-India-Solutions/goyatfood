...
const AllSubCategory = () => {
    ...
    useEffect(() => {
        const fetchSubcategories = async () => {
            try {
                const response = await axios.get('https://goyattrading.shop/api/get-subcategory'); // Adjust API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`https://goyattrading.shop/api/delete-subcategory/${id}`); // Replace with your API endpoint
