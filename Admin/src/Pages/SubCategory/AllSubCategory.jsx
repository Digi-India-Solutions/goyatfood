...
const AllSubCategory = () => {
    ...
    useEffect(() => {
        const fetchSubcategories = async () => {
            try {
                const response = await axios.get('https://api.goyattrading.shop/api/get-subcategory'); // Adjust API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`https://api.goyattrading.shop/api/delete-subcategory/${id}`); // Replace with your API endpoint
