...
const AllSubCategory = () => {
    ...
    useEffect(() => {
        const fetchSubcategories = async () => {
            try {
                const response = await axios.get('http://localhost:12006/api/get-subcategory'); // Adjust API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`http://localhost:12006/api/delete-subcategory/${id}`); // Replace with your API endpoint
