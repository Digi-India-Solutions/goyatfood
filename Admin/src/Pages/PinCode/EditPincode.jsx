...
const EditPincode = () => {
    ...
    useEffect(() => {
        ...
        const fetchPincodeDetails = async () => {
            try {
                const response = await axios.get(`https://api.goyattrading.shop/api/single-pincode/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goyattrading.shop/api/update-pincode/${id}`, pincodeData);
