...
const EditCategory = () => {
    ...
    useEffect(() => {
        ...
        const fetchCategory = async () => {
            try {
                const response = await axios.get(`https://api.goyattrading.shop/api/signle-category/${id}`);
    ...
    const handleFormSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goyattrading.shop/api/update-category/${id}`, formData, {
                headers: {
