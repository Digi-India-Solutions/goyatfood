...
const AllCategory = () => {
    ...
    useEffect(() => {
        const fetchCategories = async () => {
            try {
                const response = await axios.get('https://goyattrading.shop/api/all-category'); // Replace with your API endpoint
    ...
    const handleDelete = async (id) => {
        ...
        if (confirmDelete.isConfirmed) {
            try {
                await axios.delete(`https://goyattrading.shop/api/delete-category/${id}`); // Replace with your API endpoint
