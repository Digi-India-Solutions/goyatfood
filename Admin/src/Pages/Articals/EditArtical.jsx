...
const EditArtical = () => {
    ...
    useEffect(() => {
        const fetchArticalData = async () => {
            try {
                const response = await axios.get(`https://api.goyattrading.shop/api/single-artical/${id}`);
                setData({
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.put(`https://api.goyattrading.shop/api/update-artical/${id}`, formData, {
                headers: {
