...
const AllArtical = () => {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            setIsLoading(true);
            try {
                const response = await axios.get('https://api.goyattrading.shop/api/all-articals');
    ...
    const handleDelete = async (articleId) => {
        try {
            ...
            if (result.isConfirmed) {
                await axios.delete(`https://api.goyattrading.shop/api/delete-artical/${articleId}`);
