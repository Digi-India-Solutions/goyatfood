...
const EditVouchers = () => {
    ...
    useEffect(() => {
        const fetchVoucher = async () => {
            try {
                const response = await axios.get(`https://api.goyattrading.shop/api/single-vouchers/${id}`);
    ...
    const handleSubmit = async (e) => {
        ...
        setIsLoading(true);
        try {
            await axios.put(`https://api.goyattrading.shop/api/update-vouchers/${id}`, voucherData);
