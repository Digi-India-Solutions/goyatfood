...
const getOrderEmailTemplate = (checkout) => {
  ...
  return `
        ...
        <body>
            <div class="container">
                <div class="header">
                    <img src="http://localhost:12006/static/media/Logo.78593d7a3d9d4d016c48.png" alt="Goyat Trading.Co Logo">
  ...
  if (pincode) {
    try {
      const response = await axios.get(
        "http://api.goyattrading.shop/api/all-pincode"
      );
...
exports.verifyPayment = async (req, res) => {
  try {
    ...
    console.log("Incoming verify req:", req.body);
